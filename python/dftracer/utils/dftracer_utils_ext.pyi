...
class _DataFrame:
    ...
    def concat(self, *others: "_DataFrame") -> "_DataFrame": ...
    def unpivot(
    ...
    def pivot(self, index: str, columns: str, values: str, agg: str = "first") -> "_DataFrame": ...
...
class _TraceViewer:
    ...
    def agg_numeric_args(self) -> "_AggregatedTraceViewer": ...
    ...
    def join(self, other: "_TraceViewer", how: str = "inner") -> "_DataFrame":
    ...
    def _session_execute(
        self,
        branches: List[Tuple[str, "_TraceViewer", "str | None"]],
    ) -> List[object]: ...
...
class _AggregatedTraceViewer(_TraceViewer):
    ...
    def phase(self, phase: str) -> "_AggregatedTraceViewer": ...
    def time_bucket(self, interval_us: int) -> "_AggregatedTraceViewer": ...
