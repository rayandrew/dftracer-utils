...
typedef enum {
    ...
    DFTU_AGG_ARGMIN = 21,
    DFTU_AGG_BIT_OR = 22,
    DFTU_AGG_DISTINCT = 23,
    DFTU_AGG_LIST_SORTED = 24,
    DFTU_AGG_TOPK = 25,
    DFTU_AGG_BOTTOMK = 26,
    DFTU_AGG_APPROX_TOPK = 27,
    DFTU_AGG_SAMPLE = 28,
    DFTU_AGG_CORR = 29,
    DFTU_AGG_COVAR_POP = 30,
    DFTU_AGG_COVAR_SAMP = 31,
    DFTU_AGG_REGR_SLOPE = 32,
    DFTU_AGG_REGR_INTERCEPT = 33,
    DFTU_AGG_REGR_R2 = 34
} dftu_agg_op;
