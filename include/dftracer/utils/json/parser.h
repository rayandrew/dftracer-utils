#ifndef DFTRACER_UTILS_JSON_PARSER_H
#define DFTRACER_UTILS_JSON_PARSER_H
...
class JsonParser {
   ...
   private:
    ...
    std::string
        padbuf_;  ///< reused across parse() calls; grows to fit + padding
...
#endif  // DFTRACER_UTILS_JSON_PARSER_H
