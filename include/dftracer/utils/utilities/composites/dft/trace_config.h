#ifndef DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_TRACE_CONFIG_H
#define DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_TRACE_CONFIG_H
...
// member holds no end (reorganized trace, mid-file split chunk, crash); callers
...
// gzip member (US when absent/unreadable). Used to normalize ts/dur to a target
// unit without decoding the whole trace.
...
#endif  // DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_TRACE_CONFIG_H
