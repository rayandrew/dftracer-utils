#ifndef DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_SHARDED_VIEW_H
#define DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_SHARDED_VIEW_H
...
class ShardedView {
   public:
    ...
    /// merge.
    coro::CoroTask<ResultTable> aggregate(Configure configure) const;
...
#endif  // DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_SHARDED_VIEW_H
