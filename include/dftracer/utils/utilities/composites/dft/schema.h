#ifndef DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_SCHEMA_H
#define DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_SCHEMA_H
...
// "type". Only the unambiguous, closed-vocabulary cats map; anything else stays
// Unknown so a reader downstream can decide.
...
inline RecordPhase read_phase(const common::json::JsonValue& v) {
...
inline RecordPhase read_phase(common::json::JsonParser& parser,
...
inline EventType read_event_type(const common::json::JsonValue& v) {
...
#endif  // DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_SCHEMA_H
