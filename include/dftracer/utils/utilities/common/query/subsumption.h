#ifndef DFTRACER_UTILS_UTILITIES_COMMON_QUERY_SUBSUMPTION_H
#define DFTRACER_UTILS_UTILITIES_COMMON_QUERY_SUBSUMPTION_H
...
#endif  // DFTRACER_UTILS_UTILITIES_COMMON_QUERY_SUBSUMPTION_H
