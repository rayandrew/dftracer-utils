#ifndef DFTRACER_UTILS_TRACE_COMPARATOR_COMPARISON_UTILITY_H
#define DFTRACER_UTILS_TRACE_COMPARATOR_COMPARISON_UTILITY_H
...
class ComparisonUtility {
   public:
    ...
    coro::CoroTask<Result<ComparisonUtilityOutput>> operator()(
