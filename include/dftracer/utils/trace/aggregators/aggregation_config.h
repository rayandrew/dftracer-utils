#ifndef DFTRACER_UTILS_TRACE_AGGREGATORS_AGGREGATION_CONFIG_H
#define DFTRACER_UTILS_TRACE_AGGREGATORS_AGGREGATION_CONFIG_H
...
struct AggregationConfig {
    ...
    /// Hashes only the config fields that affect aggregation output, to
    /// detect whether cached aggregation data is stale.
...
#endif  // DFTRACER_UTILS_TRACE_AGGREGATORS_AGGREGATION_CONFIG_H
