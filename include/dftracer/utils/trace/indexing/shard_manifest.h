#ifndef DFTRACER_UTILS_TRACE_INDEXING_SHARD_MANIFEST_H
#define DFTRACER_UTILS_TRACE_INDEXING_SHARD_MANIFEST_H
...
#endif  // DFTRACER_UTILS_TRACE_INDEXING_SHARD_MANIFEST_H
