#ifndef DFTRACER_UTILS_TRACE_INDEXING_SUB_CHUNK_PRUNE_H
#define DFTRACER_UTILS_TRACE_INDEXING_SUB_CHUNK_PRUNE_H
...
inline NumericRange extract_and_range(
    const dftracer::utils::query::QueryNode& root, std::string_view field) {
...
inline std::vector<char> sub_chunk_keep_mask(
    ...
    const dftracer::utils::query::QueryNode& root, std::string_view ts_field,
    std::string_view dur_field) {
...
#endif  // DFTRACER_UTILS_TRACE_INDEXING_SUB_CHUNK_PRUNE_H
