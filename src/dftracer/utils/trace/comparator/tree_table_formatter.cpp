...
//
// Renders metrics as a sub-tree (branch glyphs shown here in ASCII fallback):
//   {prefix}+-- count  | ...
//   {prefix}+-- dur
//   {prefix}|   +-- mean  | ...
//   {prefix}|   `-- p50   | ...
