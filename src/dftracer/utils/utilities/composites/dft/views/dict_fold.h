#ifndef DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_DICT_FOLD_H
#define DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_DICT_FOLD_H
...
class DictFold : public Fold {
   public:
    ...
    void write_to_sink(indexer::IndexBatchSink& sink) const {
...
#endif  // DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_DICT_FOLD_H
