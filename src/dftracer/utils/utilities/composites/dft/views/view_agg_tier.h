#ifndef DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_VIEW_AGG_TIER_H
#define DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_VIEW_AGG_TIER_H
...
/// aggregation. Each row of `out_table` carries a leading "type" column
/// ("event"/"profile") so the caller can split them without a second scan.
/// Returns false (out_table untouched) when the tier cannot answer the plan
/// exactly. Requires plan.schema to be built.
...
#endif  // DFTRACER_UTILS_UTILITIES_COMPOSITES_DFT_VIEWS_VIEW_AGG_TIER_H
